...
function draw(){
  ...
  if(gameState === "start"){
    ...
    text("Then Use Arrow Keys To Collect 10 Blocks", squirrel.x-500, displayHeight/1.8);
...
function spawnAcorns(){
  if(World.frameCount % 30 === 0){
    var acorn = createSprite(squirrel.x+displayWidth,Math.round(random(displayHeight-displayHeight,displayHeight-50)),50,50);
